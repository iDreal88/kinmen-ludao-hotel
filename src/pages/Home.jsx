                ...
                <div className="about-content">
                    ...
                    <div style={{ marginTop: '2.5rem' }}>
                        ...
                        <div style={{ display: 'flex', gap: '1rem' }}>
                            <a href="https://line.me/ti/p/RnygkMl6h2" target="_blank" rel="noreferrer" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '45px', height: '45px', background: '#00B900', color: 'white', borderRadius: '50%', textDecoration: 'none', fontSize: '1.5rem', transition: 'transform 0.3s', boxShadow: '0 4px 10px rgba(0, 185, 0, 0.2)' }}>
